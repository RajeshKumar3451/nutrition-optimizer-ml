...
graph TB
    subgraph Client [Client Browser Layer]
        A[Vanilla JS Dashboard] -->|Local Validation| B[Input Guardrails <br/> Deficit & Protein Logic]
    end

    subgraph Render [Render Production Cloud Engine]
        direction TB
        C[FastAPI Router <br/> main.py] 
        D[Absolute Pathing Engine <br/> os.path.abspath]
        E[Joblib Serializer]
    ...
    B -->|4. Authenticated HTTPS POST /predict| C
